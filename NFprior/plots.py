...
def check_conditional_nsbh_model(path: str,
    ...
    save_name = f"./figures/nsbh_conditional_lambda2_m2_{m2_value:.1f}.pdf"
...
def check_conditional_model(path: str,
                            m1_value: float = 1.6,
                            m2_value: float = 1.4,
                            N_samples: int = 1_000):
    """
    ...
    name = f"./figures/cond_NF_m1_{m1_value:.2f}_m2_{m2_value:.2f}.pdf"
...
def main():
    ...
    check_conditional_model(path_bns, m1_value=1.8, m2_value=1.2, N_samples=10_000)
