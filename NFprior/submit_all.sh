...
#!/
### GW170817 ###
# python train_NF_prior.py --submit --population-type GW170817 --source-type bns --eos-samples-name radio
# python train_NF_prior.py --submit --population-type GW170817 --source-type bns --eos-samples-name radio_chiEFT
# python train_NF_prior.py --submit --population-type GW170817 --source-type bns --eos-samples-name radio_chiEFT_NICER
python train_NF_prior.py --submit --population-type GW170817 --source-type nsbh --eos-samples-name radio
python train_NF_prior.py --submit --population-type GW170817 --source-type nsbh --eos-samples-name radio_chiEFT
python train_NF_prior.py --submit --population-type GW170817 --source-type nsbh --eos-samples-name radio_chiEFT_NICER

### GW190425 ###
# python train_NF_prior.py --submit --population-type GW190425 --source-type bns --eos-samples-name radio
# python train_NF_prior.py --submit --population-type GW190425 --source-type bns --eos-samples-name radio_chiEFT
# python train_NF_prior.py --submit --population-type GW190425 --source-type bns --eos-samples-name radio_chiEFT_NICER
python train_NF_prior.py --submit --population-type GW190425 --source-type nsbh --eos-samples-name radio
python train_NF_prior.py --submit --population-type GW190425 --source-type nsbh --eos-samples-name radio_chiEFT
python train_NF_prior.py --submit --population-type GW190425 --source-type nsbh --eos-samples-name radio_chiEFT_NICER

# ### GW230529 ###
# python train_NF_prior.py --submit --population-type GW230529 --source-type bns --eos-samples-name radio
# python train_NF_prior.py --submit --population-type GW230529 --source-type bns --eos-samples-name radio_chiEFT
# python train_NF_prior.py --submit --population-type GW230529 --source-type bns --eos-samples-name radio_chiEFT_NICER
# python train_NF_prior.py --submit --population-type GW230529 --source-type nsbh --eos-samples-name radio
# python train_NF_prior.py --submit --population-type GW230529 --source-type nsbh --eos-samples-name radio_chiEFT
# python train_NF_prior.py --submit --population-type GW230529 --source-type nsbh --eos-samples-name radio_chiEFT_NICER