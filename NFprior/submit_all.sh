...
COMMON_ARGS_MAF="--glasflow-type MaskedAffineAutoregressiveFlow --batch-size 1024 --learning-rate 5e-4 --max-patience 200 --num-epochs 1500 --n-neurons 128 --n-blocks-per-transform 3 --n-transforms 3 --N-samples-training 50000"
